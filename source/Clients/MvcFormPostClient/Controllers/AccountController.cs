...
namespace MvcFormPostClient.Controllers
{
    public class AccountController : Controller
	{
        ...
        {
	        var token_id = Request.Form["id_token"];
	        var state = Request.Form["state"];

	        var claims = await ValidateIdentityTokenAsync(token_id, state);
        ...
        private async Task<IEnumerable<Claim>> ValidateIdentityTokenAsync(string token_id, string state)
        {
            ...
            SecurityToken jwt;
	        var id = handler.ValidateToken(token_id, parameters, out jwt);
        ...
        public ActionResult SignOut()
        {
            ...
            return Redirect("https://connect.acc.prov.testaws.visma.net/idsrv/core/connect/endsession?post_logout_redirect_uri=https%3A%2F%2Fconnect.acc.prov.testaws.visma.net%2Fmvc&id_token_hint="+id_token);
            //return Redirect("/mvc");
        }
